...
## Features
- LRU Caching mechanism for improved query speeds
- Automatic connection/thread pooling
- Simple and quick configuration to begin mapping entities and making calls
